...
#################################################
origin_path = '/root/shiraki/dataset/NTU-RGB+D/nturgb+d_skeletons'
output_dir_path = 'root/shiraki/dataset/gen_ntu_data/NTU-RGB+D60'
ignore_sample_path = '/root/shiraki/dataset/NTU-RGB+D/ignore_sample_ntu60.txt'
#################################################
...
def make_data_ntu(origin_path, output_path, benchmark, part):
    ...
    for filename in os.listdir(origin_path):
        ...
        # xsub or xview
        if benchmark == 'xview':
            if (subject_id in training_subjects) or (subject_id in test_subjects):
